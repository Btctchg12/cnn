...
# src/models/cnn/experiments_5000/efficientnet_b0/train.py
PROJECT_ROOT = CURRENT_FILE.parents[5]
EXPERIMENT_DIR = CURRENT_FILE.parents[1]

sys.path.append(str(EXPERIMENT_DIR))

from cnn_dataset_5000 import FTWCNNDataset5000
...
OUTPUT_DIR = PROJECT_ROOT / "models" / "experiments_5000" / "efficientnet_b0"
...
# Same setting as the 2300 EfficientNet-B0 experiment
LEARNING_RATE = 5e-5
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Training EfficientNet-B0 on 5000 full dataset")
    print("=" * 70)
