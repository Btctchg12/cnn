...
# src/models/cnn/experiments_5000/efficientnet_b0/evaluate.py
...
MODEL_DIR = PROJECT_ROOT / "models" / "experiments_5000" / "efficientnet_b0"
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Evaluating EfficientNet-B0 on 5000 full dataset")
    print("=" * 70)
    ...
    eval_dataset = FTWCNNDataset5000(
        csv_path=eval_csv,
        data_root=DATA_ROOT,
        label_col="cluster",
        use_window_a=True,
