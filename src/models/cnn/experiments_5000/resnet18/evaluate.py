...
# src/models/cnn/experiments_5000/resnet18/evaluate.py
...
MODEL_DIR = PROJECT_ROOT / "models" / "experiments_5000" / "resnet18"
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Evaluating ResNet18 on 5000 full dataset")
    print("=" * 70)
