...
# src/models/cnn/experiments_5000/resnet18/train.py
...
OUTPUT_DIR = PROJECT_ROOT / "models" / "experiments_5000" / "resnet18"
...
# Same setting as the best 2300 ResNet18 experiment
LEARNING_RATE = 1e-4
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Training ResNet18 on 5000 full dataset")
    print("=" * 70)
