...
#             Path to labeled_geometry_features.csv
#         countries : list[str] or None
#             Optional subset of countries to use
#         label_col : str
#             Column name in CSV containing the cluster/class label
#         use_window_a : bool
#             Whether to use window_a tif
#         use_window_b : bool
#             Whether to use window_b tif
#         return_metadata : bool
#             If True, also return chip_id and country
#         transform : callable or None
#             Optional transform applied to image
#         """
...
#         """
#         Read tif as float32 array with shape (C, H, W)
#         """
