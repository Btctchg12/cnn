...
# src/models/cnn/experiments_2300/efficientnet_b0/evaluate.py
...
MODEL_DIR = PROJECT_ROOT / "models" / "experiments_2300" / "efficientnet_b0"
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Evaluating EfficientNet-B0 on 2300 dataset")
    print("=" * 70)
