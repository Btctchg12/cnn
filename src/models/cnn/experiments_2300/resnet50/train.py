...
# src/models/cnn/experiments_2300/resnet50/train.py
...
OUTPUT_DIR = PROJECT_ROOT / "models" / "experiments_2300" / "resnet50"
...
# ResNet50 is larger than ResNet18, so use a smaller learning rate.
LEARNING_RATE = 5e-5
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Training ResNet50 on 2300 dataset")
    print("=" * 70)
