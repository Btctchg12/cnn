...
# src/models/cnn/experiments_2300/cnn_bn_dropout/evaluate.py
...
from model import CNNBNDropout
...
MODEL_DIR = PROJECT_ROOT / "models" / "experiments_2300" / "cnn_bn_dropout"
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Evaluating CNN_BN_Dropout on 2300 dataset")
    print("=" * 70)
