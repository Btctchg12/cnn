...
# src/models/cnn/experiments_2300/resnet18/train.py
...
OUTPUT_DIR = PROJECT_ROOT / "models" / "experiments_2300" / "resnet18"
...
# pretrained CNN should use smaller learning rate
LEARNING_RATE = 1e-4
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Training ResNet18 on 2300 dataset")
    print("=" * 70)
